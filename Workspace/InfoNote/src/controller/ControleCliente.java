...
import view.CLI.TelaAlterarCadastroCliente;
import view.CLI.TelaCadastroCliente;
import view.CLI.TelaFinalizarPedidoCliente;
import view.CLI.TelaLoginCliente;
import view.CLI.TelaMenuCliente;
import view.CLI.TelaPedidosCliente;
import view.CLI.TelaSuporteCliente;

/*
 * Nesta classe controle, utilizada pelo(a) cliente(a),
 * é possível apenas fazer compras e visualizar seus pedidos.
 */
public class ControleCliente {

	static double total = 0; // Variável que armazena o total da compra.
	static int contadorNotebookBD = 0; // Variável que armazena a quantidade de notebooks no BD.
	static int numeroDePedidos = 0; // Variável que armazena o total de pedidos realizados pelo cliente.
	boolean aberto = false; // Variável que define se o programa já foi aberto anteriormente.
	private Cliente cliente; // Variável que define o cliente.
	private static Endereco endereco; // Variável que define o endereço.
	private static ItemDePedido item; // Variável que define o item do pedido no carrinho.
	...
	// Telas instanciadas.
	private TelaLoginCliente telaLogin = new TelaLoginCliente();
	private TelaCadastroCliente telaCadastroCliente = new TelaCadastroCliente();
	private TelaMenuCliente telaMenuPrincipal = new TelaMenuCliente();
	private TelaSuporteCliente telaSuporte = new TelaSuporteCliente();
	private TelaAlterarCadastroCliente telaAlterarCadastro = new TelaAlterarCadastroCliente();
	private TelaPedidosCliente telaPedidos = new TelaPedidosCliente();
	private TelaFinalizarPedidoCliente telaFinalizarPedido = new TelaFinalizarPedidoCliente();
	...
	/*
	 * Método main, que inicia o funcionamento do software.
	 */
	...
	/*
	 * Método que conta quantos notebooks existem no banco de dados.
	 */
	...
	/*
	 * Método que adiciona produtos no carrinho.
	 */
	...
	/*
	 * Método que remove produtos no carrinho.
	 */
	...
	/*
	 * Método que conta quantos pedidos um cliente tem no banco de dados.
	 */
	...
	/*
	 * Método que fecha a tela suporte e abre o menu principal.
	 */
	...
	/*
	 * Subclasse que abre a tela de alteracao de cadastro.
	 */
	...
	/*
	 * Subclasse que altera os dados do usuario no BD.
	 */
	...
	/*
	 * Subclasse que fecha a tela de alteracao de cadastro.
	 */
	...
	/*
	 * Subclasse que abre a tela de pedidos.
	 */
	...
	/*
	 * Subclasse que fecha a tela de pedidos.
	 */
	...
	/*
	 * Subclasse que abre a tela de finalizacao de pedido, pegando o total do
	 * pedido, se o total for igual zero, não será possiível finalizar.
	 */
	...
	/*
	 * Subclasse que registra o pedido no BD, pegando a forma de pagamento escolhida
	 * pelo usuário, se for igual à "Selecione o pagamento" não será permitido a
	 * finalização. Após finalizar a variável de carrinho é limpa e a tela do menu
	 * principal é limpa para evitar erros.
	 */
	class RegistrarPedidoBD implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (telaFinalizarPedido.getComboBox() == null
					|| telaFinalizarPedido.getComboBox().trim().equals("Selecione o pagamento")) {
